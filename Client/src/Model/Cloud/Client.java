...
public class Client {
    ...
    public static int WAITTIME_SERVER = 2000;
     ...
     * @throws IOException
     */
    private synchronized void send(CommunicationPrimitive request, int waitTime, String parameters)
            throws IOException {
     ...
     * @throws Exception
     */
    private synchronized CommunicationPrimitive receive(List<String> results, boolean serverRequest)
            throws Exception {
        // Waiting for server's request
        CommunicationPrimitive response = CommunicationPrimitive.newPrimitive(
                new Scanner(new StringReader(influx.readLine())));
     ...
     * @throws Exception
     */
    public synchronized CommunicationPrimitive sendRequest(CommunicationPrimitive request,
                                                           int waitTime, String parameters,
     ...
     * @throws Exception
     */
    public synchronized CommunicationPrimitive sendRequest(CommunicationPrimitive request, int waitTime,
     ...
     * @throws Exception
     */
    public synchronized void sendLongPollingRequest(CommunicationPrimitive request, int waitTime, String parameters,
                                                    ServerListener serverListener) throws Exception {
