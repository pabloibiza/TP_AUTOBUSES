...
public class SalesDesk implements ServerListener{
    ...
    public void connect() {
        new Thread() {
            ...
            public void run() {
                ...
                while(true) {
                    try {
                        client.sendLongPollingRequest(CommunicationPrimitive.CONNECT_PUSH,
                                Client.WAITTIME_LONGPOOLING, clientID, serverListener);
                    } catch (Exception e) {
                        connected = false;
    ...
    public Travel searchTravel(String id) throws Exception{
        ...
        CommunicationPrimitive response = client.sendRequest(CommunicationPrimitive.SEARCH_TRAVEL,
                Client.WAITTIME_SERVER, parameters, results);
    ...
    public boolean assignSeat (Travel travel, Passenger passenger, int seat) throws Exception {
        ...
        String parameters = clientID + "\n" + travel.toString() + "\n" + passenger.toString() + "\n" + seat;
        List<String> results =  new ArrayList<>();
        CommunicationPrimitive response = client.sendRequest(CommunicationPrimitive.ASSIGN,
                Client.WAITTIME_SERVER, parameters, results);
    ...
    public boolean deallocateSeat(Travel travel, int seat) throws Exception{
        ...
        String parameters = clientID + "\n" + travel.toString() + "\n" +  seat;
        List<String> results =  new ArrayList<>();
        CommunicationPrimitive response = client.sendRequest(CommunicationPrimitive.DEALLOCATE,
                Client.WAITTIME_SERVER, parameters, results);
    ...
    public Passenger whoIsSitting(Travel travel, int seat) throws Exception{
        ...
        String parameters = clientID + "\n" + travel.toString() + "\n" +  seat;
        List<String> results =  new ArrayList<>();
        CommunicationPrimitive response = client.sendRequest(CommunicationPrimitive.WHO_SITTING,
                Client.WAITTIME_SERVER, parameters, results);
    ...
    public List searchTravelsPerDate(GregorianCalendar date) throws Exception{
        ...
        String parameters = clientID + "\n" + year + "\n" +  month + "\n" + day;
        List<String> results =  new ArrayList<>();
        CommunicationPrimitive response = client.sendRequest(CommunicationPrimitive.SEARCH_TRAVELS_PER_DATE,
                Client.WAITTIME_SERVER, parameters, results);
