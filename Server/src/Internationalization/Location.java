...
public class Location {
    ...
    public static final String ERROR_READING_INPUT = "ERROR_READING_INPUT";
    public static final String CONNECTION_ERROR_SALESDESK = "CONNECTION_ERROR_SALESDESK";
     ...
     */
    public Location(String language, String country) throws MissingResourceException{
        try {
